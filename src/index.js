import "./style.css";
//import("https://fonts.googleapis.com/icon?family=Material+Icons").then(font => font.default);
...
const Keyboard = {
        ...
        lout.forEach((key,ind) => {
            ...
            switch (key[0]) {
                case "backspace":
                    ...
                    keyElement.addEventListener("click", () => {
                        ...
                        if(textarea.selectionStart == textarea.selectionEnd){                                             
                            ...
                            //textarea.selectionStart = prev - 1;
                            this._triggerEvent("oninput");
                            textarea.selectionStart =  textarea.selectionEnd = prev - 1;
                        }
                        else{
                            prev = textarea.selectionStart;
                            this.properties.value = textarea.value.substring(0,textarea.selectionStart) + textarea.value.substring(textarea.selectionEnd);
                            //textarea.selectionStart = prev - 1;
                            this._triggerEvent("oninput");
                            textarea.selectionStart =  textarea.selectionEnd = prev;    
                        }                        
                    });
                ...
                case "Shift":
                    ...
                    keyElement.addEventListener("mousedown", () => this._toggleCapsLock());
                    keyElement.addEventListener("mouseup", () => this._toggleCapsLock());
                    break;
    ...
    _toggleShift() {        
        this.properties.capsLock = !this.properties.capsLock;
        this.elements.lkeys.forEach(key => key.textContent = this.properties.capsLock ? key.textContent.toUpperCase() : key.textContent.toLowerCase());    
    },
